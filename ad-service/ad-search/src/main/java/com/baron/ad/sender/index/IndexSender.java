    ...
    private void Level2RowData(MySqlRowData rowData){
        ...
        if (rowData.getTableName().equals(Constant.AD_PLAN_TABLE_INFO.TABLE_NAME)){
            ...
            for (Map<String, String> fieldValueMap: rowData.getFieldValueMap()){
                ...
                fieldValueMap.forEach((k, v) -> {switch (k){
                    case Constant.AD_PLAN_TABLE_INFO.COLUMN_ID: planTable.setId(Long.valueOf(v));
                        break;
                    case Constant.AD_PLAN_TABLE_INFO.COLUMN_USER_ID: planTable.setUserId(Long.valueOf(v));
                        break;
                    case Constant.AD_PLAN_TABLE_INFO.COLUMN_PLAN_STATUS: planTable.setPlanStatus(Integer.valueOf(v));
                        break;
                    case Constant.AD_PLAN_TABLE_INFO.COLUMN_START_DATE: planTable.setStartDate(CommonUtils.parseStringDate(v));
                        break;
                    case Constant.AD_PLAN_TABLE_INFO.COLUMN_END_DATE: planTable.setEndDate(CommonUtils.parseStringDate(v));
                        break;
                }
                });
                ...
                fieldValeMap.forEach((k, v) -> {
                    switch (k) {
                        ...
                        case Constant.AD_CREATIVE_TABLE_INFO.COLUMN_WIDTH:
                            creativeTable.setWeight(Integer.valueOf(v));
                            break;
